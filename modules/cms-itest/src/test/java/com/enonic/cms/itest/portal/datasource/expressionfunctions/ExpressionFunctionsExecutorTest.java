    ...
    extends AbstractSpringTest
{
    ...
    /**
     *
     * you have to uncomment or add
     *
     * <p/>
     * <code>// rootObject.setParam( new UserAccessorNoReflection( expressionContext.getUser() ) );</code>
     * <p/>
     * in ExpressionFunctionsExecutor
     *
     */
    @Test
    @Ignore
        ...
        throws Exception
    {
        ...
        siteProperties.setProperty( "cms.test", "overridden" );
        siteProperties.setProperty( "cms.site.test", "site" );
        efExecutor.setSiteProperties( new SiteProperties( new SiteKey( 0 ), siteProperties ) );
        ...
        {
            efExecutor.evaluate( "${user.qualifiedName}" );
        }
        ...
        for ( int i = 0; i < count; i++ )
        {
            efExecutor.evaluate( "${param.qualifiedName}" );
        }
        time = System.nanoTime() - time;
        System.out.println( time / 1000000 );
